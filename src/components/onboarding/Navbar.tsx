  ...
  return (
    <div className="text-center">
      ...
      <p className="text-[#515B6F] mt-6">
        ...
        <span className="text-red-700">test mode</span>, so there are a few more
        things to do before you can go live and start management. Follow the
        steps below to get activated.
      </p>
      <NavItems />
    </div>
  );
