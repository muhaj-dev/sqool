  ...
  return (
    <div className="bg-white rounded-md py-4 mt-8">
      <div className="flex items-center flex-wrap gap-3 justify-between border-b-2 pb-4 mb-4">
        <div>
          <h3 className="text-xl font-semibold">Tell us about the School Owner</h3>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full">
                        ...
                        <FormControl>
                          <Input placeholder="Enter first name" {...field} type="text" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="w-full">
                        ...
                        <FormControl>
                          <Input placeholder="Enter last name" {...field} type="text" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex-1">
                        ...
                        <FormControl>
                          <Input placeholder="Enter ID number" {...field} type="text" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
          ...
          {owners.length > 0 && (
            <>
              ...
              <div className="mt-6 flex justify-end">
                <Button onClick={handleSaveAndContinue} className="text-white text-lg">
                  Save and Continue
                </Button>
              </div>
            </>
