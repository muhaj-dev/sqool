...
export const columns: ColumnDef<Lesson>[] = [
  ...
  },
  {
    ...
    header: "Appoved by",
    cell: ({ row }) => (
      <div className="capitalize underline cursor-pointer">{row.getValue("approved_by")}</div>
    ),
  },
  {
    ...
    header: "Attachment",
    cell: ({ row }) => (
      <div className="capitalize text-primary underline cursor-pointer">view link</div>
    ),
  },
];
