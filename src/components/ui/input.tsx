  ...
  ({ className, type, icon, togglePassword = false, ...props }, ref) => {
    ...
    return (
      <div className="relative flex items-center">
        ...
        />
        {togglePassword && (
          <button type="button" onClick={handlePasswordToggle} className="absolute right-3 text-muted-foreground">
            {isPasswordVisible ? <EyeIcon className="w-5 h-5" /> : <EyeOffIcon className="w-5 h-5" />}
          </button>
        )}
      </div>
    )
...
const EyeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M0.458008 10C1.73201 5.943 5.52201 3 10 3C14.478 3 18.268 5.943 19.542 10C18.268 14.057 14.478 17 10 17C5.52201 17 1.73201 14.057 0.458008 10ZM14 10C14 11.0609 13.5786 12.0783 12.8284 12.8284C12.0783 13.5786 11.0609 14 10 14C8.93914 14 7.92172 13.5786 7.17158 12.8284C6.42143 12.0783 6.00001 11.0609 6.00001 10C6.00001 8.93913 6.42143 7.92172 7.17158 7.17157C7.92172 6.42143 8.93914 6 10 6C11.0609 6 12.0783 6.42143 12.8284 7.17157C13.5786 7.92172 14 8.93913 14 10Z"
      fill="#25324B"
    />
  </svg>
)
