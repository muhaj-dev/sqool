...
import { type AddStaffPayload, type StaffResponse, type StaffResult } from "@/types";
import { addStaff, getStaffs } from "@/utils/api";
...
export function useStaff() {
  const { step, updateIndex, activeIndex, staffData, refreshStaff, mutate, loading, error } =
