      ...
      <div className="flex flex-col min-h-[120vh] bg-white max-[700px]:w-full w-[25%] max-w-[280px] fixed  gap-6">
        ...
        <div className="flex flex-col gap-10 w-[90%] mx-auto">
          ...
          <Link href="/student" className={`flex items-center gap-3 pl-4`}>
            ...
            <p className={`text-[#515B6F] ${pathname === "/student" ? "text-primary" : ""}`}>
              Dashboard
            </p>
          </Link>
            ...
            <AccordionItem value="item-1" className="border-b-0">
              <AccordionTrigger>
                <div className="flex items-center gap-3 pl-4">
                  ...
                  <p
                    className={`text-[#515B6F] ${pathname === "/student/class*" ? "text-primary" : ""}`}
                  >
                    Class
                  </p>
                </div>
          ...
          <Link href="/student/payment" className={`flex items-center gap-3 pl-4`}>
            ...
            <p
              className={`text-[#515B6F] ${pathname.startsWith("/student/payment") ? "text-primary" : ""}`}
            >
              Payments
            </p>
          </Link>
          <Link href="/student/noticeboard" className={`flex items-center gap-3 pl-4`}>
            ...
            />
            <p
              className={`text-[#515B6F] ${pathname === "/student/noticeboard" ? "text-primary" : ""}`}
            >
              Notice Board
            </p>
          </Link>
          ...
          >
            <Settings
              className={`text-[#515B6F] ${pathname === "/student/settings" ? "text-primary" : ""}`}
            />
            <p
              className={`text-[#515B6F] ${pathname === "/student/settings" ? "text-primary" : ""}`}
            >
