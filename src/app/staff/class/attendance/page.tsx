...
import ADetails from "../../components/Attendance/ADetails";
import { StaffTimeTable } from "../../components/class/timetable/StaffTimeTale";
import { ATable } from "../../components/Attendance/ATable";
    ...
    <div>
      ...
      <div className="w-full mt-0 md:mt-8 bg-white py-0 md:py-5 px-0 md:px-9">
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-3 gap-6 mb-6">
          ...
          <div className="tablet:col-span-2 flex flex-col overflow-auto">
            {/* <div className="flex-1 "> */}
              <div className="flex flex-col justify-end mb-4 gap-4">
                <div className="flex items-center justify-start">
                  ...
                  >
                    <div className="text-left border border-[#515B6F] border-r-0 p-2 rounded-l-md">
                  ...
                  >
                   <div className=" text-left border border-[#515B6F] border-l-0 p-2 rounded-r-md">
