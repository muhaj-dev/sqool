...
export const EditExamModal: React.FC<EditExamModalProps> = ({ exam, isOpen, onClose, onExamUpdated }) => {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <CardDescription>Update examination details and upload new questions file if needed</CardDescription>
        </DialogHeader>
            ...
            {error ? (
              ...
              <>
                ...
                <QuestionsFileUpload
                  ...
                  isEditMode={true}
                  currentFileName={exam ? getFileNameFromUrl(exam.questions) : 'Current questions file'}
                  onDownloadCurrent={() => {
