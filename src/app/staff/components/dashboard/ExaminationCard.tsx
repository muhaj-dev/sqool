  ...
  return (
    <Card className="">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-semibold">Upcoming Examinations</CardTitle>
                  ...
                  <div className="flex-1 text-start">
                    ...
                    <div className="flex flex-col text-start gap-4 text-xs text-muted-foreground">
                      <span className="flex items-center gap-1 capitalize">
                        ...
                        Exam Date:
                        {`${format(new Date(exam.examDate), "MMM d, yyyy")}` || "TBA"}
                      </span>
                      <span className="flex items-center gap-1 capitalize">
                        <Clock className="h-3 w-3" />
                        Time:
                        {` ${format(new Date(exam.startTime), "h:mm a") || "TBA"}`}
                      </span>
                    </div>
                  </div>
                  {isApprove ? (
