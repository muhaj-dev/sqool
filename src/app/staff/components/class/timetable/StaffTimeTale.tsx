...
export const StaffTimeTable: React.FC<StaffTimeTableProps> = ({ toggleView }) => {
    ...
    <div className="w-full">
      <div className="flex items-center py-4 justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-3 items-center">
          <Button variant="default" className="px-3 text-primary" onClick={() => toggleView('upload')}>
            Upload Timetable
          </Button>
          <Button onClick={() => toggleView('download')} className="px-3 text-white" icon={<Export />}>
            Export
          </Button>
        </div>
      </div>
