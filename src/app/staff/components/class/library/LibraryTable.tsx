...
export function LibraryTable({ data, columns }: { data: ILibrary[]; columns: ColumnDef<ILibrary>[] }) {
        ...
        <section className="f">
          <>
            {pathname.startsWith('/student') ? ( // Replace with your specific route
              <Button className="px-3 bg-primary text-white border border-input">Download</Button>
            ) : (
              <Dialog>
