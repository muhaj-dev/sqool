...
import { Bell, Calendar, Clock, Loader2, Pin, Users, Wallet } from "lucide-react";
...
import { type Child, type Expense, type Notice } from "@/types";
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {notice?.isPinned ? <Pin className="h-4 w-4 text-primary" /> : null}
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge
                            variant="outline"
