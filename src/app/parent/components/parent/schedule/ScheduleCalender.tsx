...
import { Calendar, type EventProps, momentLocalizer, type ToolbarProps } from "react-big-calendar";
...
const ColoredDateCellWrapper: React.FC<PropsWithChildren<any>> = ({ children }) => (
