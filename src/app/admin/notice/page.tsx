...
import { getAllNotices, createNotice, updateNotice, deleteNotice } from '@/utils/api'
...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {new Date(notice.expirationDate) < new Date() && <Badge variant="destructive">Expired</Badge>}
                      </div>
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      ...
                      <Button variant="outline" size="sm" onClick={() => handleDelete(notice.id!)} disabled={loading}>
      ...
      <NoticeDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} notice={editingNotice} onSave={handleSave} />
    </div>
  )
}
