...
import { FeeStructure, CreateFeeData, UpdateFeeData, GetFeesParams } from '@/types'
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>View and manage all fee structures across classes and sessions</CardDescription>
            </div>
          </div>
                    ...
                    >
                      ...
                      <TableCell className="text-right" onClick={e => e.stopPropagation()}>
                        <div className="flex justify-end gap-2">
                          ...
                          <Button size="sm" variant="ghost" onClick={() => handleEdit(fee)} title="Edit Fee Structure">
      ...
      <Dialog open={isPublishDialogOpen} onOpenChange={setIsPublishDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="flex justify-end gap-3 mt-4">
            <Button type="button" variant="outline" onClick={handlePublishCancel} disabled={publishing}>
              Cancel
            </Button>

            <Button type="button" variant="default" onClick={handlePublishConfirm} disabled={publishing} className="">
              {publishing ? (
                <>
