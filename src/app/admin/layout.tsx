...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <section className="relative flex max-w-[1740px] w-[100%] mx-auto gap-3 align-baseline ">
      <div className={`min-[800px]:block hidden max-[800px]:w-[0%] w-[25%] max-w-[280px]`}>
        <Sidebar toggleSidebar={toggleSidebar} />
      </div>
      {isOpen ? (
        <div className="fixed bg-black z-30 bg-opacity-70 max-[800px]:block hidden w-screen h-screen">
          <div
      ...
      <main className="bg-white min-[850px]:bg-transparent max-[800px]:w-full w-[75%] ">
