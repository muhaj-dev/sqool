...
import { type SingleStaffResponse, type StaffResult, type StaffSchedule } from "@/types";
  ...
  return (
    <>
      ...
      <section className="flex gap-8 flex-col lg:flex-row w-full">
        <LeftBar staffId={staffId} staff={staffData.staff} loading={loading} error={error} />
