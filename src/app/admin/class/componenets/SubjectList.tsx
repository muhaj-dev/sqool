...
const SubjectList = ({ classes = [], classData, onRefresh }: SubjectListProps) => {
  ...
  const filteredClasses = classes.filter(
    cls => cls.name.toLowerCase().includes(classSearch.toLowerCase()) && !form.classes.includes(cls.id),
  )
        ...
        <Dialog open={modalOpen} onOpenChange={setModalOpen}>
          ...
          <DialogContent>
            ...
            <form className="space-y-4" onSubmit={handleCreateSubject}>
              ...
              <Input name="code" placeholder="Subject Code" value={form.code} onChange={handleChange} required />
