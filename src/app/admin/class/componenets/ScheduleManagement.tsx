              ...
              >
                ...
                <SelectContent>
                  {teachers.length > 0 ? (
                    ...
                    >
                      No Teacher has been assigned to this class yet, please assign teacher to this
                      class
                    </SelectItem>
                  )}
                </SelectContent>
            ...
            <DialogDescription>
              ...
              {deletingSchedule ? (
                <div className="mt-4 p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {deletingSchedule.teacher.userId.firstName}{" "}
                    {deletingSchedule.teacher.userId.lastName}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {formatTime(deletingSchedule.startTime)} -{" "}
                    {formatTime(deletingSchedule.endTime)}
                  </p>
                </div>
              ) : null}
            </DialogDescription>
