    ...
    <MaxWidthWrapper>
      ...
      <Wrapper className="h-screen sm:w-[60%] w-full  mx-auto gap-4">
        <div className="text-center">
          ...
          <p className="text-[#515B6F]">Cross check your number or enter another phone number to receive your OTP.</p>
        </div>
        <div className="flex items-center w-full  gap-2">
          <Form {...form}>
            <form action="" onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col gap-4 sm:gap-6  ">
              <FormField
              ...
              />
              <Button className="text-white font-semibold bg-primary  w-full mb-4">Resend OTP</Button>
            </form>
          </Form>
        </div>
      </Wrapper>
