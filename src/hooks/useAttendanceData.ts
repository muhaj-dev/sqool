...
const mockStudents: Record<string, StudentAttendance[]> = {
  "p3-math": [
    ...
    },
    {
      ...
      attendanceRate: 88,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Chidi",
      status: "absent",
    },
    {
      id: "4",
    ...
    },
    {
      ...
      attendanceRate: 96,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ngozi",
      status: "absent",
    },
    {
      id: "21",
      ...
      attendanceRate: 91,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Biodun",
      status: "absent",
    },
    {
      id: "22",
      ...
      gender: "female",
      age: 8,
      guardianName: "Mrs. Yusuf",
      attendanceRate: 93,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Halima",
      status: "absent",
    },
    {
      id: "23",
      ...
      attendanceRate: 87,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Chinonso",
      status: "absent",
    },
    {
      id: "24",
      ...
      attendanceRate: 95,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Rukayat",
      status: "absent",
    },
    {
      id: "25",
      ...
      attendanceRate: 89,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Emmanuel",
      status: "absent",
    },
    {
      id: "26",
    ...
    },
    {
      ...
      gender: "male",
      age: 9,
      guardianName: "Mr. Oladele",
      attendanceRate: 90,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Segun",
      status: "absent",
    },
    {
      id: "28",
      ...
      gender: "female",
      age: 8,
      guardianName: "Mrs. Sanni",
      attendanceRate: 94,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Aminat",
      status: "absent",
    },
  ],
  "p3-science": [
    ...
    },
    {
      ...
      guardianName: "Mrs. Yusuf",
      attendanceRate: 91,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Hauwa",
      status: "absent",
    },
    {
      id: "11",
      ...
      gender: "male",
      age: 9,
      guardianName: "Mr. Balogun",
      attendanceRate: 88,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Oluwaseun",
      status: "absent",
    },
    {
      id: "12",
      ...
      gender: "female",
      age: 8,
      guardianName: "Mrs. Abubakar",
      attendanceRate: 96,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=ZainabA",
      status: "absent",
    },
  ],
  "p4-math": [
    ...
    },
    {
      ...
      attendanceRate: 95,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Blessing",
      status: "absent",
    },
    {
      id: "15",
  ...
  "p5-science": [
    ...
    },
    {
      ...
      attendanceRate: 88,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Oluwatobi",
      status: "absent",
    },
    {
      id: "20",
      ...
      gender: "female",
      age: 10,
      guardianName: "Mrs. Musa",
      attendanceRate: 95,
      photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Khadija",
      status: "absent",
    },
  ],
};
